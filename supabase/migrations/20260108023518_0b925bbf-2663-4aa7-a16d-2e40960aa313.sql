...
-- Evitar borrar cuentas globales super_admin al eliminar una congregación
...
BEGIN
  ...
  -- Excluir super_admin global para no dejar al sistema sin acceso global.
  ...
  -- Eliminar registros públicos de usuarios huérfanos (si aplica)
