...
export const TIPOS_ASIGNACION_SERVICIO: { value: TipoAsignacionServicio; label: string; tipoCampo: "individual" | "grupo"; soloFinSemana?: boolean; respParticipante?: string; soloAncianos?: boolean }[] = [
  ...
  { value: "pasillo_1", label: "Micrófono Pasillo #1", tipoCampo: "individual", respParticipante: "microfono_pasillo_1" },
  { value: "pasillo_2", label: "Micrófono Pasillo #2", tipoCampo: "individual", respParticipante: "microfono_pasillo_2" },
  { value: "acomodador_auditorio", label: "Acomodador Auditorio", tipoCampo: "individual", respParticipante: "acomodador_auditorio", soloAncianos: true },
  { value: "acomodador_entrada_1", label: "Acomodador Entrada #1", tipoCampo: "individual", respParticipante: "acomodador_entrada_1" },
  { value: "acomodador_entrada_2", label: "Acomodador Entrada #2", tipoCampo: "individual", respParticipante: "acomodador_entrada_2" },
