...
export function WhatsAppAyuda() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex flex-col items-center gap-1.5 transition-transform hover:scale-105"
    >
      <span className="rounded-full bg-[#25D366] px-2.5 py-1 text-xs font-semibold text-white shadow">
        ¡Ayuda!
      </span>
      <span className="flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg hover:shadow-xl">
