...
function CeldaDiaEspecial({ mensaje }: { mensaje: string }) {
  return (
    <div className="dia-esp-tooltip max-w-[130px] mx-auto cursor-help" data-tooltip={mensaje}>
      <div className="truncate font-bold uppercase text-[11px] text-foreground">{mensaje}</div>
    </div>
  );
}
